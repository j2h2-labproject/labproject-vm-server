...
module.exports = {
    ...
    handles: function(command) {
        valid_commands = ['vm_host_info', 'vm_exists', 'create_vm', 'delete_vm', 'list_snapshots', 'start_vm', 'stop_vm', 'vm_is_running', 'suspend_vm', 'update_vm', 'get_vm_config', 'restore_vm_snapshot', 'make_vm_snapshot', 'delete_vm_snapshot', 'vm_console', 'attach_vm_drive', 'detach_vm_drive']
